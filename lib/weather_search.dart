...
class _WeatherSearchState extends State<WeatherSearch> {
  // Final means that the variable must be initalized when an
  // instance of the class is initialized.
  // Once it is initialized, it cannot change.
  // Setting the textController to a default initializer
  // of TextEditingController()
  final textController = TextEditingController();

  // Disposes of the text controller when the widget is disposed
  @override
  void dispose() {
